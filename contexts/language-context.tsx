...
const translations = {
  "zh-CN": {
    ...
    "contact.storePhoto": "我们的店面",
    "contact.storeLocation": "店面位置",
    "contact.contactInfo": "联系信息",
    "contact.callNow": "立即拨打",
    "contact.sendMessage": "发送消息",
    "contact.quickContact": "快速联系我们",
    "contact.mondayToSaturday": "周一至周六",
    "contact.sunday": "周日",
    "contact.closed": "休息",
    "contact.storeDescription": "欢迎来到我们的实体店面，这里有各种精美的礼品、气球和花束等您选择。",
    "contact.readyToOrder": "准备好订购了吗？",
    "contact.readyToOrderDesc": "浏览我们的产品或直接联系我们获取个性化建议。",
    "contact.viewProducts": "查看产品",
    "contact.whatsappContact": "WhatsApp联系",
    "contact.helpDescription": "我们很乐意为您提供帮助！请通过以下方式与我们联系。",
  ...
  en: {
    ...
    "contact.storePhoto": "Our Store",
    "contact.storeLocation": "Store Location",
    "contact.contactInfo": "Contact Information",
    "contact.callNow": "Call Now",
    "contact.sendMessage": "Send Message",
    "contact.quickContact": "Quick contact with us",
    "contact.mondayToSaturday": "Monday to Saturday",
    "contact.sunday": "Sunday",
    "contact.closed": "Closed",
    "contact.storeDescription":
      "Welcome to our physical store, where you can find various exquisite gifts, balloons and bouquets for your selection.",
    "contact.readyToOrder": "Ready to Order?",
    "contact.readyToOrderDesc": "Browse our products or contact us directly for personalized recommendations.",
    "contact.viewProducts": "View Products",
    "contact.whatsappContact": "WhatsApp Contact",
    "contact.helpDescription": "We're happy to help you! Please contact us through the following ways.",
  ...
  ms: {
    ...
    "contact.businessHours": "Waktu Perniagaan",
    "contact.storePhoto": "Kedai Kami",
    "contact.storeLocation": "Lokasi Kedai",
    "contact.contactInfo": "Maklumat Hubungan",
    "contact.callNow": "Hubungi Sekarang",
    "contact.sendMessage": "Hantar Mesej",
    "contact.quickContact": "Hubungi kami dengan pantas",
    "contact.mondayToSaturday": "Isnin hingga Sabtu",
    "contact.sunday": "Ahad",
    "contact.closed": "Tutup",
    "contact.storeDescription":
      "Selamat datang ke kedai fizikal kami, di mana anda boleh menemui pelbagai hadiah indah, belon dan jambangan untuk pilihan anda.",
    "contact.readyToOrder": "Bersedia untuk Tempah?",
    "contact.readyToOrderDesc": "Lihat produk kami atau hubungi kami terus untuk cadangan yang diperibadikan.",
    "contact.viewProducts": "Lihat Produk",
    "contact.whatsappContact": "Hubungi WhatsApp",
    "contact.helpDescription": "Kami gembira membantu anda! Sila hubungi kami melalui cara berikut.",
